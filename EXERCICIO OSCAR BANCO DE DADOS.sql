...
-- 11 Inclua no banco 3 filmes que nunca foram nomeados ao Oscar, mas que na sua opinião, merecem. 
...
SELECT year_ceremony, category, film, name from movies where category in ('BEST PICTURE','ACTRESS','DIRECTING') and year_ceremony ='1995' and winner like '1';
 -- Resposta: 2 indicações
    
 1995	DIRECTING	Forrest Gump    Robert Zemeckis
 1995	BEST PICTURE	Forrest Gump   Wendy Finerman, Steve Tisch and Steve Starke....    
...
-- Meus pais que sempre me apoiaram e estiveram do meu lado todos momentos que eu precisei.
...
INSERT INTO movies (year_film, year_ceremony, ceremony, category, `name`, film, winner) VALUES ('2022', '2023', '94', 'MOTHER OF THE YEAR', 'Rozinete Maria do Nascimento', 'A Mãe do Ano', '1');
 ...
 10397	2022	2023	94	BEST DAD	Edgar da Silva Garoli	1
 10398	2022	2023	94	MOTHER OF THE YEAR	Josefa Ramos de Moura Garoli 1
